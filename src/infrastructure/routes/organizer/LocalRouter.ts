...
export class LocalRouter {
    ...
    private initializeRoutes(): void {
        this.router.post('/create', [...schemas.register, handleValidationErrors.handle, this.accessHandler.groupAccess.bind(this.accessHandler)],
            (req: Request, res: Response) =>
                this.localController.createLocal(req, res)
        );

        this.router.put('/:localId/update', [...schemas.update, handleValidationErrors.handle, this.accessHandler.localAccess.bind(this.accessHandler)],
            (req: Request, res: Response) =>
                this.localController.updateLocal(req, res)
        );

        this.router.get('/group/:groupId', [...schemas.getLocals, handleValidationErrors.handle, this.accessHandler.groupAccess.bind(this.accessHandler)],
            (req: Request, res: Response) =>
                this.localController.getLocals(req, res)
        );

        this.router.get('/:localId/details', [...schemas.detail, handleValidationErrors.handle, this.accessHandler.localAccess.bind(this.accessHandler)],
            (req: Request, res: Response) =>
